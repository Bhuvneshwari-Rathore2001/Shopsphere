const Banner = () => {
  return (
    <div className='relative'>
      ...
      <div className='text-white absolute top-[50vh] text-center max-w-[50%] left-[50vh] lg:text-base md:text-sm text-xs'>
        ...
        <button className='uppercase max-md:text-sm'>view collection</button>
      </div>
    </div>
  );
}

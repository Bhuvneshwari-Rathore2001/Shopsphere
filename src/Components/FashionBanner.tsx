const FashionBanner = () => {
  return (
    <div className='bg-[url("https://websitedemos.net/clothing-store-02/wp-content/uploads/sites/1447/2024/03/bg-04.jpg")] h-screen w-screen bg-cover bg-no-repeat flex items-center justify-center'>
      <div className='text-center flex flex-col items-center justify-center'>
        <div></div>
        <div className='text-white font-sans w-3/6 font-bold text-3xl'>
